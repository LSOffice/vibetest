...
exports.cookieSecurityCheck = void 0;
...
exports.cookieSecurityCheck = {
    id: "cookie-security",
    name: "Cookie Security & Scope",
    description: "Analyzes Set-Cookie headers for security flags and potential scope issues.",
            ...
            try {
                ...
                if (setCookie && Array.isArray(setCookie)) {
                    for (const cookieStr of setCookie) {
                        ...
                        if (processedCookies.has(cookieName))
                            continue;
                        ...
                        if (!samesite) {
                            findings.push({
                                ...
                                assumption: "Modern browsers default to Lax, but explicit is better.",
                                reproduction: `Inspect headers on ${route.path}`,
