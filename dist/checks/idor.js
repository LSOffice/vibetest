...
exports.idorCheck = void 0;
exports.idorCheck = {
    id: "idor-check",
    name: "Insecure Direct Object References (IDOR)",
    description: "Checks if changing ID parameters allows access to other objects",
    async run({ axios, apiAxios, discoveredRoutes, config }) {
        ...
        const idRoutes = discoveredRoutes.filter((r) => /\/\d+$/.test(r.path) || /\/[a-f0-9-]{36}$/.test(r.path));
                    ...
                    try {
                        ...
                        if (res.status === 200) {
                            ...
                            findings.push({
                                ...
                                assumption: "Developer assumed sequential IDs are obscure or ownership is implicitly checked.",
